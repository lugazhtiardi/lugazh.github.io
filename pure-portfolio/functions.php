...
if ( ! defined( 'PURE_PORTFOLIO_VERSION' ) ) {
	...
	define( 'PURE_PORTFOLIO_VERSION', '1.0.7' );
}
...
function pure_portfolio_scripts() {
	...
	// Navigation script.
	wp_enqueue_script( 'pure-portfolio-navigation-script', get_template_directory_uri() . '/assets/js/navigation' . $min . '.js', array(), PURE_PORTFOLIO_VERSION, true );
