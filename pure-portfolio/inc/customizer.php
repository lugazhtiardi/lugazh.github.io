...
function pure_portfolio_customize_preview_js() {
	...
	wp_enqueue_script( 'pure-portfolio-customizer', get_template_directory_uri() . '/assets/js/customizer' . $min . '.js', array( 'customize-preview' ), PURE_PORTFOLIO_VERSION, true );
}
...
function pure_portfolio_custom_control_scripts() {
	...
	wp_enqueue_style( 'pure-portfolio-custom-controls-css', get_template_directory_uri() . '/assets/css/custom-controls' . $min . '.css', array(), '1.0', 'all' );
	wp_enqueue_script( 'pure-portfolio-custom-controls-js', get_template_directory_uri() . '/assets/js/custom-controls' . $min . '.js', array( 'jquery', 'jquery-ui-core', 'jquery-ui-sortable' ), '1.0', true );
}
